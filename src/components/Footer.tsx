    ...
    <footer className="bg-[#151515] text-white pt-10">
      <div className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-4">
          ...
          {/* Row 1 */}
          <div className="p-8 lg:p-12 flex items-center justify-between group cursor-pointer hover:bg-white/5 transition-colors">
            <span className="text-[1.35rem] font-medium tracking-wide">Google Maps</span>
            <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
          </div>
          <div className="p-8 lg:p-12 flex items-center justify-between group cursor-pointer hover:bg-white/5 transition-colors">
            <span className="text-[1.35rem] font-medium tracking-wide">+1 123 123 12</span>
            <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
          </div>
          <div className="flex flex-col">
            <div className="flex-1 p-8 lg:px-10 flex items-center justify-between group cursor-pointer hover:bg-white/5 transition-colors">
          ...
          <div className="md:row-span-2 p-8 lg:p-12 flex flex-col justify-between min-h-[400px]">
            <div>
